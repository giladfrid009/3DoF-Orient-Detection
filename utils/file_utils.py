...
class LogFiles(Files):
    def __init__(self, directory: str, extention: str = '.pickle', scan_dirs: bool = False, return_full_path: bool = True) -> None:
        super().__init__(directory, extention, scan_dirs, return_full_path)

    def _load(self) -> MealLog:
        return MealLog.load(self.get_path())
